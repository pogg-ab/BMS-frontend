...
export default function QR() {
  ...
  return (
    <PageLayout 
      ...
      actions={
        <div className="flex flex-wrap bg-slate-100 dark:bg-slate-900 p-1 rounded-xl w-full sm:w-fit">
          <button
            onClick={() => setTab('manage')}
            className={`px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm font-bold rounded-lg transition-all flex-1 sm:flex-none text-center ${tab === 'manage' ? 'bg-white dark:bg-slate-800 text-indigo-600 dark:text-indigo-400 shadow-sm' : 'text-slate-500 hover:text-slate-700'}`}
          >
            Management
          </button>
          <button
            onClick={() => setTab('analytics')}
            className={`px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm font-bold rounded-lg transition-all flex-1 sm:flex-none text-center ${tab === 'analytics' ? 'bg-white dark:bg-slate-800 text-indigo-600 dark:text-indigo-400 shadow-sm' : 'text-slate-500 hover:text-slate-700'}`}
          >
            Analytics
          </button>
        </div>
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <PermissionGate permission="qr:export_pdf">
                        <button
